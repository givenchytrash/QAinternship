...
public class AsosQA {
	...
	public void testTitle() throws InterruptedException
	{
		...
		try 
		{
			drv.findElement(By.xpath("//*[@id=\"chrome-app-container\"]/section[1]/div"));
		} catch (WebDriverException e) 
		{
			System.out.println("There is no such element on this page...");
		}
		tstlog.info("Checking title of site");
	}
	...
	public void ShippingCancel() throws InterruptedException 
	{
		...
		Thread.sleep(6000);
		tstlog.info("Belarus shipping cancel");
	}
	...
	public void SneakerTest() throws InterruptedException 
	{
		...
		Thread.sleep(5000);
		tstlog.info("Sneakers purchased");
	}
	...
	public void inst() {
		...
		instpage.click();
		tstlog.info("Instagram hyperlink tested");
